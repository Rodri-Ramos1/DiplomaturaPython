...
class App(tk.Tk):
    ...
    def configurar_ventana(self):
        ...
        self.iconbitmap(r'clase 11\tiendaElectIcon.ico')
    ...
    def mostrar_titulo(self):
        etiqueta = ttk.Label(self, text="Tienda de electrodomesticos", font=('Arial',20), foreground='white', background='#1d2d44')
    ...
    def mostrar_formulario(self):
        ...
        lnombre.grid(row=0, column=0, sticky = tk.W, pady=10)
        ...
        ldescripcion.grid(row=1, column=0, sticky = tk.W, pady=10)
    ...
    def cargar_tabla(self):
        ...
        self.estilos.configure('Treeview', background="white", foreground="black", fieldbackground="black", rowheight=20)
